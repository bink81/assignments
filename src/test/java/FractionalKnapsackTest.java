...
public class FractionalKnapsackTest {
	...
	public void testZeroSpace() throws Exception {
		int[] values = new int[] {};
		int[] weights = new int[] {};
		double actual = FractionalKnapsack.getOptimalValue(ZERO_SPACE, values, weights);
	...
	public void testSomeSpaceButItemsWithNoWeight() throws Exception {
		...
		double actual = FractionalKnapsack.getOptimalValue(SOME_SPACE, values, weights);
	...
	public void test50() throws Exception {
		...
		double actual = FractionalKnapsack.getOptimalValue(50, values, weights);
	...
	public void test10() throws Exception {
		...
		double actual = FractionalKnapsack.getOptimalValue(10, values, weights);
	...
	public void testRandomValues() throws Exception {
		...
		FractionalKnapsack.getOptimalValue(100, values, weights);
	}

	private int[] generateRandomValues(int recordSize) {
		List<Integer> randomNumbers = new RandomArrayGenerator(recordSize, 100).generateRandomNumbers();
