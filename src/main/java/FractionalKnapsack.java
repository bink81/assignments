	...
	public static double getOptimalValue(int capacity, int[] values, int[] weights) {
		...
		for (Integer mostValuableIndex : positionsOrderedByValueToWeight) {
			...
			totalValue = totalValue
					+ availableSpace * values[mostValuableIndex] / availableWeights[mostValuableIndex];
			availableWeights[mostValuableIndex] = availableWeights[mostValuableIndex] - availableSpace;
